...
namespace SaltCategories\Providers;

use Illuminate\Support\ServiceProvider;

class SaltCategoriesServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'categories');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/categories'),
        // ], 'translations');
        ...
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/categories'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \SaltCategories\Console\Commands\SaltCategoriesCommand::class,
        //     ]);
        // }
